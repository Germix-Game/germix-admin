...
import { clueCardCategoryOptions } from "@/lib/clue-cards";
    ...
    <section className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-[0_18px_40px_-28px_rgba(15,23,42,0.22)] md:p-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex flex-col gap-2">
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">Clue cards</p>
          <h2 className="text-2xl font-semibold tracking-tight text-slate-950">Card records</h2>
          <p className="text-sm leading-6 text-slate-600">Add one card or upload a CSV for bulk import.</p>
        </div>
      ...
      <p className="mt-4 text-sm leading-6 text-slate-500">PNG files should already exist in the public image folder.</p>
    </section>
  );
}